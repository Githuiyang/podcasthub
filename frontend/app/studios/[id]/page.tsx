    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 sm:py-6 pb-16 sm:pb-0 animate-fade-in-up">
      <div className="max-w-xl mx-auto">
        ...
        <div className="h-52 sm:h-64 bg-gradient-to-br from-studio-100 via-studio-50 to-amber-50 rounded-2xl overflow-hidden mb-5 relative">
          {studio.cover_image ? (
            <Image src={studio.cover_image} alt={studio.name} fill className="object-cover" sizes="(max-width: 640px) 100vw, 576px" priority />
          ) : (
          ...
          <div className="mb-5 pb-5 border-b border-slate-100 space-y-3">
            ...
            {studio.booking_qr_image && (
              <div className="flex items-start gap-3">
                <div className="w-24 h-24 rounded-lg overflow-hidden bg-white border border-slate-100 shrink-0 relative">
                  <Image src={studio.booking_qr_image} alt="预约二维码" fill className="object-contain" sizes="96px" />
                </div>
                <div>
