                ...
                <div>
                  ...
                  {form.cover_image && (
                    <div className="mt-2 relative w-32 h-24 rounded-xl overflow-hidden bg-gray-100">
                      <Image src={form.cover_image} alt="封面" fill className="object-cover" sizes="128px" />
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {form.booking_qr_image && (
                    <div className="mt-2 flex items-start gap-3">
                      <div className="w-28 h-28 rounded-xl overflow-hidden bg-gray-100 border border-gray-200 relative">
                        <Image src={form.booking_qr_image} alt="预约二维码" fill className="object-contain" sizes="112px" />
                      </div>
                      <button
                        type="button"
