            ...
            <div className="space-y-2">
              ...
              {studio.booking_qr_image && (
                <div className="mt-2">
                  ...
                  <div className="w-32 h-32 rounded-xl overflow-hidden bg-white border border-slate-100 relative">
                    <Image src={studio.booking_qr_image} alt="预约二维码" fill className="object-contain" sizes="128px" />
                  </div>
                </div>
              )}
